        ...
        <div className="max-w-2xl mx-auto">
          ...
          {plots.length === 0 ? (
            ...
            <div className="space-y-3 mb-6">
              {plots.map(plot => (
                <div key={plot.id} className="bg-card rounded-2xl p-4 border border-border/60 shadow-sm">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="font-sans text-sm font-bold text-foreground">{plot.name}</h3>
