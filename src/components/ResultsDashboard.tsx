...
const glassCard = "bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.1)_0%,_rgba(255,255,255,0.6)_100%)] backdrop-blur-xl border border-white/60 shadow-[0_20px_60px_-10px_rgba(2,44,34,0.2)] rounded-2xl";
const glassCardHover = `${glassCard} hover:bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.2)_0%,_rgba(255,255,255,0.7)_100%)] hover:shadow-[0_25px_70px_-10px_rgba(2,44,34,0.28)] hover:-translate-y-1 transition-all duration-300`;
