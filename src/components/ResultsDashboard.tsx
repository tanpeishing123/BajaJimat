  ...
  const buildWhatsAppText = () => {
    ...
    const message = lang === 'bm'
      ? [
          ...
          ``,
          `_Dijana oleh AgroMate — bajajimat.lovable.app_`,
        ]
      : [
          `*AgroMate Fertiliser List*`,
          ``,
          ...
          ``,
          `_Generated by AgroMate — bajajimat.lovable.app_`,
        ];
    ...
    <div className="h-screen flex flex-col overflow-hidden" style={{ background: '#f0fdf4' }}>
      ...
      <div className="hidden print:block p-8">
        ...
        <div className="mt-8 pt-4 border-t text-center text-xs text-muted-foreground">
          <p>AgroMate — {t(lang, 'Smart Fertiliser Optimiser', 'Pengoptimum Baja Pintar')}</p>
